    ...
    render() {
        return (
            <div className='signup-main-container'>
                ...
                >
                    <Grid item >
                        <Typography variant="h5" style={{ marginBottom: "1em", width: '100%', marginTop: "1em", fontWeight: "bold" }}>
                            SIGN UP
                        </Typography>
                    </Grid>
                    <form>
                        ...
                        <Grid item style={{ marginBottom: "1.5em" , width: '30vw', position: "relative"}}>
                            <FormGroup>
                                <FormControlLabel 
                                    control={<Checkbox />}
                        ...
                        <Grid item style={{ width: '30vw', position: "relative" , marginBottom: "1em"}}>
                            <Button
                                type="submit"
                                variant="contained"
                                color="primary"
                    ...
                    <Grid item justifyContent="center" alignItems="center" display="flex" style={{ width: '30vw', position: "relative" , marginBottom:"0.3em"}}>
